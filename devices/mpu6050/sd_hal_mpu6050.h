 ...
 * @}
 */
#define MPU6050_NORM_FACTOR ((float) ((float)360 / 0xffff))
/**
 * @}
 */
...
/**
 * @brief  Filters data from accelerometer
 * @param  currentData: Pointer to @ref MPU6050_t structure to store data to
 * @retval Member of @ref MPU6050_Result_t:
 *            - MPU6050_Result_Ok: everything is OK
 *            - Other: in other cases
 */
...
/**
 * @brief  MPU6050 poll thread
 * @param  None
 * @retval None
 *           
 *         
 */
void MPU6050_poll_thread(void*);
/**
 * @brief  Main thread
 * @param  None
 * @retval None
